...
layui.define(['element',"fsConfig","fsCommon"], function(exports){
	...
	var menuConfig = {
			...
			data : [
				...
				{"menuId":"laboratory","menuName":"实验室","menuIcon":"fa-list","menuHref":"views/laboratory/index.html","parentMenuId":"11"},
				{"menuId":"student","menuName":"联动数据表格","menuIcon":"fa-list","menuHref":"views/student/index.html","parentMenuId":"11"},
				// {"menuId":"linkageDatagrid2","menuName":"添加","menuIcon":"fa-list","menuHref":"views/user/add.html","parentMenuId":"11"},
				{"menuId":"user","menuName":"用户管理","menuIcon":"fa-list","menuHref":"views/user/index.html","parentMenuId":"11"},
