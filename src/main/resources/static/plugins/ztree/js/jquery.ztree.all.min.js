...
(function (r) {
    var I, J, K, L, M, N, v, s = {}, w = {}, x = {}, O = {
            ...
            var a = b.target, c = h.getSetting(b.data.treeId), d = "", e = null, g = "", k = "", p = null, i = null,
                q = null;
            ...
            return {stop: !1, node: e, nodeEventType: g, nodeEventCallback: p, treeEventType: k, treeEventCallback: i}
        }], C = [function (b) {
            var a = h.getRoot(b);
            a || (a = {}, h.setRoot(b, a));
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d, e) {
            if (!b.data.keep.leaf || !a || a.isParent) if (j.isArray(d) || (d = [d]), b.data.simpleData.enable && (d = h.transformTozTreeFormat(b, d)), a) {
                var g = l(a, f.id.SWITCH, b), k = l(a, f.id.ICON, b), p = l(a, f.id.UL, b);
                if (!a.open) i.replaceSwitchClass(a, g, f.folder.CLOSE),
                    i.replaceIcoClass(a, k, f.folder.CLOSE), a.open = !1, p.css({display: "none"});
            ...
            if (j.isArray(b.async.otherParam)) for (e = 0, g = b.async.otherParam.length; e < g; e += 2) k[b.async.otherParam[e]] = b.async.otherParam[e + 1]; else for (var q in b.async.otherParam) k[q] = b.async.otherParam[q];
            ...
            for (e = d.length - 1; e >= 0; e--) if (g = d[e], a === g || !a && (!c || c !== g)) if (l(g, f.id.A, b).removeClass(f.node.CURSELECTED), a) {
            ...
            if (c && c.length != 0) {
                var g = h.getRoot(b), k = b.data.key.children, k = !d || d.open || !!l(d[k][0], b).get(0);
                g.createdNodes = [];
            ...
            if (a) {
                ...
                if (a.open == c) j.apply(e,
                    []); else {
                    var c = l(a, f.id.UL, b), g = l(a, f.id.SWITCH, b), n = l(a, f.id.ICON, b);
        ...
        makeDOMNodeNameBefore: function (b, a, c) {
                        ...
                        function b(a, d, e, f) {
                            return {
                                ...
                                relativeFromTo: function (k, h) {
                                    var i = a, j = d, k = k.offsetParent, h = h.offsetParent;
                                    if (k === h) return g;
            ...
            if (h.getNodeCache(b,
                ...
                h.removeSelectedNode(b, a);
                for (var g = 0, k = e[d].length; g < k; g++) if (e[d][g].tId == a.tId) {
                    e[d].splice(g, 1);
                    break
                }
                i.setFirstNode(b, e);
                i.setLastNode(b, e);
                var j, g = e[d].length;
                if (!b.data.keep.parent && g == 0) e.isParent = !1, e.open = !1, g = l(e, f.id.UL, b), k = l(e, f.id.SWITCH, b), j = l(e, f.id.ICON, b), i.replaceSwitchClass(e, k, f.folder.DOCU), i.replaceIcoClass(e, j, f.folder.DOCU), g.css("display", "none"); else if (b.view.showLine && g > 0) {
            ...
            if (a) {
                var c = l(a, f.id.SWITCH, b), d = l(a, f.id.UL, b), e = l(a, f.id.ICON, b), g = i.makeUlLineClass(b, a);
            ...
            var c = h.getNodeTitle(b, a), d = l(a, f.id.SPAN, b);
            d.empty();
        ...
        consts: {
            ...
            var e = {
                setting: d, addNodes: function (a, b, c, e) {
                    ...
                    b !== !0 && b !== !1 && (b = !a.open);
                    if ((f = !!f) && b && j.apply(d.callback.beforeExpand,
                            [d.treeId, a], !0) == !1) return null; else if (f && !b && j.apply(d.callback.beforeCollapse, [d.treeId, a], !0) == !1) return null;
                    ...
                    for (var b = d.data.key.children,
                             c = a.parentTId ? a.getParentNode() : h.getRoot(d), e = 0, f = c[b].length; e < f; e++) if (c[b][e] == a) return e;
                    return -1
